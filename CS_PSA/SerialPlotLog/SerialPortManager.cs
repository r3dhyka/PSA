...
namespace SerialPlotLog.Serial
{
    /// <summary>
    ...
    public class SerialPortManager : IDisposable
    {
        ...
        void _serialPort_DataReceived(object sender, SerialDataReceivedEventArgs e)
        {
            ...
            byte[] data = new byte[dataLength];*/
                ...
                string nilai = _serialPort.ReadLine();
            //List<string> nilaiArray = new List<string>();
            //nilaiArray.Add(nilai);

            int nbrnilai = nilai.Length;
                ...
                if (NewSerialDataRecieved != null)
                    ...
                    NewSerialDataRecieved(this, new SerialDataEventArgs(nilai));
    ...
    public class SerialDataEventArgs : EventArgs
    {
        ...
        public byte[] Data;
        */
        public SerialDataEventArgs(string nilaiInStringArray)
        {
            Nilai = nilaiInStringArray;
        }
        public string Nilai;
    }
}
